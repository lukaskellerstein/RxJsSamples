...
describe('ExhaustMap', () => {
    ...
    it('should ends in expected way', () => {
      ...
      scheduler.run(helpers => {
        ...
        const result = obs1.pipe(
          exhaustMap(x => obs2.pipe(map(y => Number(x) + Number(y))))
        );
  ...
  describe('ASWW - two stages - var 1.', () => {
    it('should ends in expected way', () => {
      const scheduler = new TestScheduler(assertDeepEqual);
  ...
  describe('NNOP - two stages - var 2.', () => {
    it('should ends in expected way', () => {
      const scheduler = new TestScheduler(assertDeepEqual);
